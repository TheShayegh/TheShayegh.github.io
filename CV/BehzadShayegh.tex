	...
	\begin{minipage}{\linewidth}
		\dirtree{%
			...
			.2  \begin{minipage}[t]{6.27cm}\vspace{-7pt}
					...
					\small $\bullet$ \href{https://github.com/BehzadShayegh/BehzadShayegh.github.io/blob/master/CV/BCsCEreport.pdf}{GPA: 18.41/20 (3.93/4) \includegraphics[width=8pt]{icons/redirect.png}}\\
			...
			.2  \begin{minipage}[t]{6.27cm}\vspace{-7pt}
					...
					\small $\bullet$ \href{https://github.com/BehzadShayegh/BehzadShayegh.github.io/blob/master/CV/BCsCSreport.pdf}{GPA: 19.73/20 (4/4) \includegraphics[width=8pt]{icons/redirect.png}}\\
