...
\begin{minipage}[t]{0.36\textwidth} 
	...
	\begin{minipage}{\linewidth}
		\dirtree{%
			...
			.3  \begin{minipage}[t]{5.78cm}\vspace{-7pt}
					\runsubsection{\small Focused in Software Engineering}\\
					\hspace{-0.49cm}\hspace{0.25cm} \small \href{https://github.com/BehzadShayegh/BehzadShayegh.github.io/blob/master/CV/BCsCEreport.pdf}{GPA: 18.41/20 (3.93/4) \includegraphics[width=8pt]{icons/redirect.png}}\\
					\hspace{-0.49cm}\hspace{0.29cm} \small GPA over the last two years: 18.61/20\\% (3.88/4)
			...
			.2  \begin{minipage}[t]{6.27cm}\vspace{-7pt}
					...
					\hspace{0.25cm} \small  \href{https://github.com/BehzadShayegh/BehzadShayegh.github.io/blob/master/CV/BCsCSreport.pdf}{GPA: 19.73/20 (4/4) \includegraphics[width=8pt]{icons/redirect.png}}\\
	...
	\descriptright{\href{https://rtis2.ut.ac.ir/cv/mgtabesh/?lang=en-gb}{Assoc. Prof. Mohammad Ganjtabesh \includegraphics[width=8pt]{icons/redirect.png}}}
	\vspace{5pt}
	...
	\descriptright{\href{https://rtis2.ut.ac.ir/cv/z.rezaeigh/?lang=en-gb}{Assoc. Prof. Zahra Rezaei Ghahroodi \includegraphics[width=8pt]{icons/redirect.png}}}
	\vspace{5pt}
...
\begin{minipage}[t]{0.595\textwidth} 
	...
	\begin{minipage}{0.85\textwidth\vspace{5pt}}
		...
		\end{justifying}
		\vspace{-0.4cm}\descriptright{\href{https://rtis2.ut.ac.ir/cv/mgtabesh/?lang=en-gb}{Assoc. Prof. Mohammad Ganjtabesh \includegraphics[width=8pt]{icons/redirect.png}}}
	\end{minipage}
...
\begin{minipage}[t]{0.5\textwidth}
	...
	\begin{minipage}{0.26\textwidth} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\end{minipage}
	\end{minipage}
	\begin{minipage}{0.73\textwidth\vspace{6pt}}
	...
	\begin{minipage}{\linewidth}
		...
		\dirtree{%
			...
			.2  \vspace{2pt}\normalfont\normalsize IELTS Exam \DTcomment Soon to be taken.
			.2  \vspace{2pt}\normalfont\normalsize GRE Exam \DTcomment Soon to be taken.
		}
	\end{minipage}
\end{minipage}
\hfill
...
\begin{minipage}[t]{0.47\textwidth}
	...
	\end{minipage}
	\begin{minipage}{0.8\textwidth\vspace{5pt}}
	...
	\begin{minipage}[t]{\textwidth}
		...
		\end{minipage}
		\begin{minipage}{0.89\textwidth\vspace{6pt}}
		...
		\begin{minipage}{0.11\textwidth} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			\vspace{-3pt}\datecolor{2017}
		\end{minipage}
		\begin{minipage}{0.92\textwidth\vspace{6pt}}
			\hspace{-0.48cm}
			\normalsize
			\begin{minipage}{\linewidth}
				\dirtree{%
					...
					.3  \normalfont\small Ranked 544\textsuperscript{th} among 52808 regional participants.
					.3  \normalfont\small Ranked 2021\textsuperscript{th} among 137788 national participants.
					.2  \normalfont Art Discipline.
					.3  \normalfont\small Ranked 731\textsuperscript{th} among 16875 regional participants.
					.3  \normalfont\small Ranked 2115\textsuperscript{th} among 48673 national participants.
				}
			\end{minipage}
		\end{minipage}
...
\begin{minipage}[t]{0.97\textwidth}
	...
	\begin{minipage}{\linewidth}
		\dirtree{%
			...
			\end{minipage}.
			.2  \begin{minipage}{0.84\textwidth}\vspace{3pt}\normalfont
				\large\href{https://behzadshayegh.github.io/Assignments-CNS-Spring2021}{Understand the parameters in SNNs (10 Parts) \includegraphics[width=8pt]{icons/redirect.png}}
				\\\vspace{3pt}
	...
	\begin{minipage}{\linewidth}
		\dirtree{%
			...
			\end{minipage}.
			.2  \begin{minipage}{0.84\textwidth}\vspace{3pt}\normalfont
				\large\href{https://github.com/BehzadShayegh/SpamDitection-IMDB-Using-Bert-Elmo}{IMDB Sentiment Analysis and Emails Spam Ditection using Bert and Elmo \includegraphics[width=8pt]{icons/redirect.png}}
				\\\vspace{3pt}
	...
	\begin{minipage}{\linewidth}
		\dirtree{%
			...
			\end{minipage}.
			.2  \begin{minipage}{0.84\textwidth}\vspace{3pt}\normalfont
				\large\href{https://github.com/BehzadShayegh/SpamDitection}{Emails Spam Detection using Naive Bayes \includegraphics[width=8pt]{icons/redirect.png}}
				\\\vspace{3pt}
				\normalfont\normalsize\dcvtag{NLP}\dcvtag{Text Classification}\dcvtag{Naive Bayes}\dcvtag{English}\dcvtag{Python}
				\\\vspace{3pt}
			\end{minipage}.
